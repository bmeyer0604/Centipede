...
class Game {
    ...
    setMonster() {
        if(this.monsters.length === 0) {
            let randNum = Math.floor(Math.random() * 5000);
            if(randNum === 13) {
    ...
    startScreen() {
        ...
        this.context.fillText(`CENTIPEDE`, this.DIM_X * .25, this.DIM_Y * .4);
        this.context.font = "24px Comic Sans MS";
        this.context.fillText("Press any key to start", this.DIM_X * .3, this.DIM_Y * .5);
    ...
    gameoverScreen() {
        ...
        this.context.fillStyle = "yellow";
        this.context.font = "48px Comic Sans MS";
        this.context.fillText(`GAME OVER`, this.DIM_X * .25, this.DIM_Y * .4);
        this.context.font = "24px Comic Sans MS";
        this.context.fillText("Press any key to try again", this.DIM_X * .28, this.DIM_Y * .5);
